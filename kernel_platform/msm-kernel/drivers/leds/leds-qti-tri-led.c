...
#if IS_ENABLED(CONFIG_ZTEMT_BREATH_LEDS)
					...
					const char *buf, size_t count)
{
	...
	if (1 == breath_param.red_green_blue) {
		breath_param.red_magic_mode = breath_param.breath_mode;
		LED_DEBUG("save valid breath_mode, breath_mode:%d, red_green_blue:%d", (int)breath_param.breath_mode, (int)breath_param.red_green_blue);
	}
