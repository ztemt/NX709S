				...
				size_t count)
{
	...
	if (calibration_flag == 0 ){	
		err = aw8697_load_vibrator_calibiration(aw8697);
		pr_err("%s: 2222222valu erere=%d\n", __func__, err);
	}
	calibration_flag = 1;
	pr_err("%s: aw8697_vibrator_work_routine  value=%d\n", __func__, (aw8697->f0_calib_data));
			    ...
			    const struct i2c_device_id *id)
{
	...
	pr_err("%s: aw8697 pinctrl inited, set state to active successfully.\n", __func__);
#endif
